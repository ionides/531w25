...
* Various difficulties were encountered with installing Xcode and Fortran compilers for Mac and R-tools for Windows. However, with persistence and some problem-solving, these were all resolved.
