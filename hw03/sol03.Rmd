...
temp.dat <- read.table(file="http://ionides.github.io/531w25/01/ann_arbor_weather.csv",header=TRUE)
...
Z <- read.table(file="http://ionides.github.io/531w25/02/Global_Temperature.txt",header=TRUE)
...
lines(Z$Year,Z$Annual*10*9/5,col="red",lty="dashed")
lines(Z$Year,Z$Annual*9/5,col="blue",lty="dotted")
```
