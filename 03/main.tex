...
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlnum{123456789}\hldef{)}
\hldef{ar1} \hlkwb{<-} \hlkwd{arima.sim}\hldef{(}\hlkwd{list}\hldef{(}\hlkwc{ar}\hldef{=}\hlnum{0.6}\hldef{),}\hlkwc{n}\hldef{=}\hlnum{100}\hldef{,}\hlkwc{sd}\hldef{=}\hlnum{1}\hldef{)}
\hlkwd{plot}\hldef{(ar1,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{X} \hlkwb{<-} \hlkwd{numeric}\hldef{(N)}
\hldef{X[}\hlnum{1}\hldef{]} \hlkwb{<-} \hlkwd{rnorm}\hldef{(}\hlnum{1}\hldef{,}\hlkwc{sd}\hldef{=}\hlkwd{sqrt}\hldef{(}\hlnum{1.56}\hldef{))}
\hlkwa{for}\hldef{(n} \hlkwa{in} \hlnum{2}\hlopt{:}\hldef{N) X[n]} \hlkwb{<-} \hlnum{0.6} \hlopt{*} \hldef{X[n}\hlopt{-}\hlnum{1}\hldef{]} \hlopt{+} \hlkwd{rnorm}\hldef{(}\hlnum{1}\hldef{)}
\hlkwd{plot}\hldef{(X,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\hlkwd{points}\hldef{(}\hlkwd{lag}\hldef{(ar1,}\hlopt{-}\hlnum{13}\hldef{),}\hlkwc{col}\hldef{=}\hlsng{"red"}\hldef{,}\hlkwc{pch}\hldef{=}\hlnum{1}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{N} \hlkwb{<-} \hlnum{100}
\hlkwd{set.seed}\hldef{(}\hlnum{123456789}\hldef{)}
\hldef{X1} \hlkwb{<-} \hlkwd{arima.sim}\hldef{(}\hlkwd{list}\hldef{(}\hlkwc{ma}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{1.5}\hldef{,}\hlnum{1}\hldef{)),}\hlkwc{n}\hldef{=N,}\hlkwc{sd}\hldef{=}\hlnum{1}\hldef{)}
\hlkwd{set.seed}\hldef{(}\hlnum{123456789}\hldef{)}
\hldef{epsilon} \hlkwb{<-} \hlkwd{rnorm}\hldef{(N}\hlopt{+}\hlnum{2}\hldef{)}
\hldef{X2} \hlkwb{<-} \hlkwd{numeric}\hldef{(N)}
\hlkwa{for}\hldef{(n} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{N) X2[n]} \hlkwb{<-} \hldef{epsilon[n}\hlopt{+}\hlnum{2}\hldef{]}\hlopt{+}\hlnum{1.5}\hlopt{*}\hldef{epsilon[n}\hlopt{+}\hlnum{1}\hldef{]}\hlopt{+}\hldef{epsilon[n]}
\hlkwd{plot}\hldef{(X1,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{) ;} \hlkwd{plot}\hldef{(X2,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{all}\hldef{(X1}\hlopt{==}\hldef{X2)}
\end{alltt}
\begin{verbatim}
[1] TRUE
\end{verbatim}
...
\hldef{N} \hlkwb{<-} \hlnum{100}
\hlkwd{set.seed}\hldef{(}\hlnum{123456789}\hldef{)}
\hldef{epsilon} \hlkwb{<-} \hlkwd{rnorm}\hldef{(N)}
\hlkwd{plot}\hldef{(epsilon,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{sp} \hlkwb{<-} \hlkwd{read.table}\hldef{(}\hlsng{"sp500.csv"}\hldef{,}\hlkwc{sep}\hldef{=}\hlsng{" "}\hldef{,}\hlkwc{header}\hldef{=}\hlnum{TRUE}\hldef{)}
\hldef{date} \hlkwb{<-} \hlkwd{as.Date}\hldef{(sp}\hlopt{$}\hldef{Date)}
\hldef{sp500} \hlkwb{<-} \hldef{sp}\hlopt{$}\hldef{Close}
\hlkwd{plot}\hldef{(sp500}\hlopt{~}\hldef{date,}\hlkwc{log}\hldef{=}\hlsng{"y"}\hldef{,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{,}\hlkwc{xlab}\hldef{=}\hlsng{"date"}\hldef{,}\hlkwc{ylab}\hldef{=}\hlsng{"S&P 500"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{mu} \hlkwb{<-} \hlkwd{mean}\hldef{(}\hlkwd{diff}\hldef{(}\hlkwd{log}\hldef{(sp500)))}
\hldef{sigma} \hlkwb{<-} \hlkwd{sd}\hldef{(}\hlkwd{diff}\hldef{(}\hlkwd{log}\hldef{(sp500)))}
\hldef{N} \hlkwb{<-} \hlkwd{length}\hldef{(sp500)}
\hldef{X1} \hlkwb{<-} \hlkwd{log}\hldef{(sp500[}\hlnum{1}\hldef{])}\hlopt{+}\hlkwd{cumsum}\hldef{(}\hlkwd{c}\hldef{(}\hlnum{0}\hldef{,}\hlkwd{rnorm}\hldef{(N}\hlopt{-}\hlnum{1}\hldef{,}\hlkwc{mean}\hldef{=mu,}\hlkwc{sd}\hldef{=sigma)))}
\hldef{X2} \hlkwb{<-} \hlkwd{log}\hldef{(sp500[}\hlnum{1}\hldef{])}\hlopt{+}\hlkwd{cumsum}\hldef{(}\hlkwd{c}\hldef{(}\hlnum{0}\hldef{,}\hlkwd{rnorm}\hldef{(N}\hlopt{-}\hlnum{1}\hldef{,}\hlkwc{mean}\hldef{=mu,}\hlkwc{sd}\hldef{=sigma)))}
\hlkwd{plot}\hldef{(X1,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{) ;} \hlkwd{plot}\hldef{(X2,}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{z} \hlkwb{<-} \hlkwd{diff}\hldef{(}\hlkwd{log}\hldef{(sp500))}
\hlkwd{acf}\hldef{(z)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{acf}\hldef{(}\hlkwd{abs}\hldef{(z}\hlopt{-}\hlkwd{mean}\hldef{(z)),}\hlkwc{lag.max}\hldef{=}\hlnum{200}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{itemize}
\item   Compiled on {\today} using \Rlanguage version 4.4.2.
