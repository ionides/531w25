...
D. A model with randomly changing variance looks appropriate for these data. Despite the sample variance being clearly time-varying, an appropriate model can be stationary.
