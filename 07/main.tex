...
\begin{alltt}
\hldef{N} \hlkwb{<-} \hlnum{100}\hldef{;  phi} \hlkwb{<-} \hlnum{0.8}\hldef{;  sigma} \hlkwb{<-} \hlnum{1}
\hldef{V} \hlkwb{<-} \hlkwd{matrix}\hldef{(}\hlnum{NA}\hldef{,N,N)}
\hlkwa{for}\hldef{(m} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{N)} \hlkwa{for}\hldef{(n} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{N) V[m,n]}\hlkwb{<-}\hldef{sigma}\hlopt{^}\hlnum{2}\hlopt{*}\hldef{phi}\hlopt{^}\hlkwd{abs}\hldef{(m}\hlopt{-}\hldef{n)}\hlopt{/}\hldef{(}\hlnum{1}\hlopt{-}\hldef{phi}\hlopt{^}\hlnum{2}\hldef{)}
\hldef{V_eigen} \hlkwb{<-} \hlkwd{eigen}\hldef{(V,}\hlkwc{symmetric}\hldef{=}\hlnum{TRUE}\hldef{)}
\hlkwd{matplot}\hldef{(V_eigen}\hlopt{$}\hldef{vectors[,}\hlnum{1}\hlopt{:}\hlnum{5}\hldef{],}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\hlkwd{matplot}\hldef{(V_eigen}\hlopt{$}\hldef{vectors[,}\hlnum{6}\hlopt{:}\hlnum{9}\hldef{],}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=11cm]{tmp/figure/eigen-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{round}\hldef{(V_eigen}\hlopt{$}\hldef{values[}\hlnum{1}\hlopt{:}\hlnum{9}\hldef{],}\hlnum{2}\hldef{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{y} \hlkwb{<-} \hlkwd{read.table}\hldef{(}\hlkwc{file}\hldef{=}\hlsng{"ann_arbor_weather.csv"}\hldef{,}\hlkwc{header}\hldef{=}\hlnum{TRUE}\hldef{)}
\hlkwd{head}\hldef{(y[,}\hlnum{1}\hlopt{:}\hlnum{9}\hldef{],}\hlnum{3}\hldef{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{low} \hlkwb{<-} \hldef{y}\hlopt{$}\hldef{Low}
\hldef{low[}\hlkwd{is.na}\hldef{(low)]} \hlkwb{<-} \hlkwd{mean}\hldef{(low,} \hlkwc{na.rm}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{spectrum}\hldef{(low,} \hlkwc{main}\hldef{=}\hlsng{"Unsmoothed periodogram"}\hldef{)}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=\maxwidth]{tmp/figure/periodogram-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{spectrum}\hldef{(low,} \hlkwc{spans}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{3}\hldef{,}\hlnum{5}\hldef{,}\hlnum{3}\hldef{),} \hlkwc{main}\hldef{=}\hlsng{"Smoothed periodogram"}\hldef{,}
  \hlkwc{ylim}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{15}\hldef{,}\hlnum{100}\hldef{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=10cm]{tmp/figure/smoothed_periodogram-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(}\hlkwd{spec.taper}\hldef{(}\hlkwd{rep}\hldef{(}\hlnum{1}\hldef{,}\hlnum{100}\hldef{)),}\hlkwc{type}\hldef{=}\hlsng{"l"}\hldef{,}
  \hlkwc{main}\hldef{=}\hlsng{"Default taper in R, for a time series of length 100"}\hldef{)}
\hlkwd{abline}\hldef{(}\hlkwc{v}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{10}\hldef{,}\hlnum{90}\hldef{),}\hlkwc{lty}\hldef{=}\hlsng{"dotted"}\hldef{,}\hlkwc{col}\hldef{=}\hlsng{"red"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=8cm]{tmp/figure/taper_plot-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{spectrum}\hldef{(low,}\hlkwc{method}\hldef{=}\hlsng{"ar"}\hldef{,}
  \hlkwc{main}\hldef{=}\hlsng{"Spectrum estimated via AR model picked by AIC"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=11cm]{tmp/figure/ar_periodogram-1} 
