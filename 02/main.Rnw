...
\url{https://climate.nasa.gov/vital-signs/global-temperature/}. These data are in degrees Celsius measured as an anomaly from a 1951-1980 base. This is climatology jargon for saying that the sample mean of the temperature over the interval 1951-1980 was subtracted from all time points.
...
\item We acknowledge \link{https://ionides.github.io/531w25/acknowledge.html}{students and instructors for previous versions of this course}.
\end{itemize}
}
