...
This solution is based on [ionides.github.io/531w24/hw01/sol01.html](https://ionides.github.io/531w22/hw01/sol01.html).
It is okay to look at the previous solution, if you acknowledge it.
In that case, it is appropriate for your report to discuss the relationship between your work and the previous solution.
Also, it is your responsibility to show a contribution that goes beyond the source in order to get full credit.
See the [../rubric_homework.html](homework grading rubric) for more discussion of this.
...
1. [Notes for STATS/DATASCI 531, Modeling and Analysis of Time Series Data](https://ionides.github.io/531w25/)
