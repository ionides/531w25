...
Another basic thing to do is to fit an **auto-regressive moving average** (ARMA) model. We'll look at ARMA models in much more detail later in the course. Let's fit an ARMA model given by
