...
seir_global_results = read.csv("SEIR_Global.csv")
seir_global_results |>
...
foreach(guess=iter(guesses,"row"), .combine=rbind,
  ...
  mf1 |>
    mif2(params=guess,
         rw.sd=rw_sd(b1=0.01, b2=0.02, b3=0.02, mu_EI = 0.02, mu_IR=0.02, mu_RS=0.02, eta=ivp(0.02))) |>
...
write.csv(profile_results, "Rho_Profile.csv")
