...
foreach(guess=iter(guesses,"row"), .combine=rbind,
  ...
  mf1 |>
    mif2(params=guess,
         rw.sd=rw_sd(b1=0.01, b2=0.02, b3=0.02, k1 = 0.01, k2 = 0.02, k3=0.02, rho1=.02, rho2=.02, mu_EI = 0.005, mu_IR=0.005, mu_RS=0.00, eta=ivp(0.02))) |>
...
write.csv(profile_results, "Rho3_profile_800.csv")
