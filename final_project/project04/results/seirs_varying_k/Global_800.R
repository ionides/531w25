...
set.seed(2062379496)
runif_design(
  lower=c(b1=0, b2= 20, b3 = 20, k1 = 0, k2 = 0, k3 = 0, mu_EI = 1, mu_IR =0.4, rho=0.2, eta=0),
  upper=c(b1=15, b2 = 80, b3 = 60, k1 = 5, k2=10, k3= 2, mu_EI = 5, mu_IR =0.8, rho=0.5, eta=0.5),
  nseq=NUM_GUESSES
) -> guesses
mf1 <- mifs_local[[1]]
...
write.csv(seir_global_results, "Global_800.csv")
